...
const fieldShortDescription = formContainerChange.querySelector(
  ".field-short-description",
);
const fieldDetailedDescription = formContainerChange.querySelector(
      ...
      ticket.addEventListener("click", (event) => {
        ...
        if (event.target.classList.contains("change")) {
          ...
          fieldShortDescription.value =
            event.target.parentNode.childNodes[3].childNodes[1].textContent;
          fieldDetailedDescription.value =
            event.target.parentNode.parentNode.childNodes[3].childNodes[1].textContent;
        }

        cancelBtnChange.addEventListener("click", () => {
        ...
        okBtnChange.addEventListener("click", () => {
          if (
            !formContainerChange.classList.contains("hidden") &&
            formContainerChange.childNodes[1].childNodes[5].textContent &&
            formContainerChange.childNodes[1].childNodes[9].textContent
          ) {
            formContainerChange.style.visibility = "hidden";
            formContainerChange.classList.add("hidden");
          }
        ...
        okBtnDlete.addEventListener("click", () => {
          if (!formContainerDelete.classList.contains("hidden")) {
            formContainerDelete.style.visibility = "hidden";
            formContainerDelete.classList.add("hidden");
          }
